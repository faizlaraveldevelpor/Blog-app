...
export let Api=createApi({
    reducerPath:"api",
    baseQuery:fetchBaseQuery({baseUrl:"http://localhost:3000/api/v1/",credentials:"include"}),tagTypes:["user","blog","like","comment","cetagory"],keepUnusedDataFor:24*60*60*1000,
